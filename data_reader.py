...
class DataReader(object):
    ...
    def __init__(self, config, train_path=None, token_to_id=None,
        ...
        if train_path is None:
            ...
            full_token_and_id_zl = list(full_token_and_id)
            self.full_token_to_id = dict(full_token_and_id_zl)
            self.token_to_id = dict(full_token_and_id_zl[:max_vocabulary_size])
